 ...
 */
public class PolygonSerializer implements Json.Serializer<PolygonData>{
	@SuppressWarnings({"rawtypes" })
	@Override
	public void write(Json json, PolygonData object,  Class knownType) {
		json.writeObjectStart();
		json.writeValue("type", "polygon");
	...
	@SuppressWarnings({ "rawtypes" })
	@Override
	public PolygonData read(Json json, Object jsonData, Class type) {
