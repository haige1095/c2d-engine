...
public class Nehe07_TextureFilters_Lighting extends Engine {
	@Override
...
//					gl.glBindTexture(GL10.GL_TEXTURE_2D, texturesBuffer.get(sceneState.filter));
					...
					Engine.getDefaultFont().setScale(0.5f);
					Engine.getDefaultFont().drawMultiLine(Engine.getSpriteBatch(), "Fling to rotate,Tap to switch mode\nThe method use :"+TextureFilter.values()[i],
							300, 340);
